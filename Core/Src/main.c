...
SystemMode_t currentMode = MODE_FREQ;
uint8_t pwm_run = 0;   // 0 = stop, 1 = run
/* USER CODE END PTD */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : EcSW_Pin */
  GPIO_InitStruct.Pin = EcSW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(EcSW_GPIO_Port, &GPIO_InitStruct);
